Vue.component('help-box', {
  ...
  <div>
    ...
    <p v-if="annotateAnnotation"
       style="position: absolute; right: 7.5vmin; top: 11vmin; font-size: 4vmin; text-align: center"
       v-html="magicBox"></p>
  </div>
  ...
  methods: {
    createNotes(){
      ...
      let infoButtonR = infoButton.width + infoButton.width/2
      ...
      d3.select('body')
        ...
        .style('left', infoButton.left + infoButton.width/2 + 'px')
        .style('top', infoButton.top + infoButton.width/2 +'px')
